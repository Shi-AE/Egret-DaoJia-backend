package com.edj.trade.constant;
...
public class TradingConstant {
    ...
    // 【平台:交易渠道】
    // 阿里支付
    public static final String TRADING_CHANNEL_ALI_PAY = TradingChannel.ALI_PAY.name();
    // 微信支付
    public static final String TRADING_CHANNEL_WECHAT_PAY = TradingChannel.WECHAT_PAY.name();
    // 现金
