...
public class ErrorInfo {
    public static class Msg {
        public static final String PROCESS_FAILED = "失败";
        /**
         * 请求异常默认异常信息
         */
    ...
    public static class Code {
         ...
         * 账号冻结
         */
        public static final int ACCOUNT_FREEZE = 605;
         ...
         * 抢单失败
         */
        public static final int SEIZE_ORDERS_FAILED = 608;
         ...
         * 抢券失败
         */
        public static final int SEIZE_COUPON_FAILED = 611;
    }
}
