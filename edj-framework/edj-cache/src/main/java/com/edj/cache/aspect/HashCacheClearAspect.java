package com.edj.cache.aspect;

import cn.hutool.extra.spring.SpringUtil;
import com.edj.cache.annotations.HashCacheClear;
import com.edj.cache.handler.HashCacheKeyHandler;
import com.edj.cache.helper.CacheHelper;
import com.edj.cache.helper.JudgeRemoveCacheHandler;
import com.edj.common.utils.AspectUtils;
...
public class HashCacheClearAspect {
    ...
    public Object pageClear(ProceedingJoinPoint pjp, HashCacheClear hashCacheClear) throws Throwable {
        ...
        // 4.批量清理缓存
        if (hashCacheClear.batchFieldIdsIndex() >= 0) {
            // 4.1.批量清理缓存
